        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <div className="mt-6 flex gap-4">
              <Link
                to="/connect"
                className="inline-block bg-white text-emerald-700 font-semibold px-5 py-3 rounded-lg shadow"
              >
                Join Us This Sunday
              </Link>
              <a
                                    ...
                                    {variant === 2 ? (
                                        ...
                                        <>
                                            ...
                                            <div className="p-6 flex flex-col justify-between h-[250px]">
                                                <div>
                                                    <h3 className={`text-xl font-bold text-[#04164B] mb-2 ${variant === 1 ? "text-teal-700" : "group-hover:text-red-600"} transition-colors`}>
                                                        {event.title}
                                                    </h3>
                                                    <p className="text-gray-600 text-sm mb-3">
                                                        📍 {event.location}
